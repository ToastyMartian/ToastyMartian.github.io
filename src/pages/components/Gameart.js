        ...
        <div className='font-overpass'>
            ...
            <section className='bg-cyan-dark mx-8 rounded-tl-large mt-10'>
                ...
                <div className='flex justify-evenly'>
                    <img className='max-w-1/5' src={billyThumb} alt='Pixel render of Billy and the giant worm'/>
            ...
            <section className='bg-cyan-dark mx-8 rounded-tl-large mt-20'>
                ...
                <div className='flex justify-evenly'>
                    <img className='max-w-1/5' src={androThumb} alt='Render of dark street with the title Androchtizo'/>
                    <div className='text-purple-light font-thin max-w-prose self-center'>
            ...
            <section className='bg-cyan-dark mx-8 rounded-tl-large mt-20'>
                ...
                <div className='flex justify-evenly'>
                    <img className='max-w-1/5 overflow-hidden' src={uuThumb} alt='Title screen of Uganda Unexplored'/>
                    <div className='text-purple-light font-thin max-w-prose self-center'>
